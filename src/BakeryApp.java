...
public class BakeryApp {
    public static void main(String[] args){
        ...
        System.out.print("What is your dietary restriction? Enter here: ");
            ...
            for (int i = 0; i < tempGoods.size();i++){
                for (int j = 0; j < tempGoods.get(i).getDietaryRes().size(); j++){
                    if (!restrict.equals("eggs")){
                        ...
                        System.out.println("\n");
                     //   System.out.printf("Dietary Restrictions: %s\n", tempGoods.get(i).getDietaryRes().get(j));
